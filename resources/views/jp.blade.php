                                    ...
                                    <table class="table table-responsive-sm text-dark">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/jp/edit/{{ $row->id }}"  class="btn btn-warning">Edit</a>
                                                    <a href="/jp/delete/{{ $row->id }}" onclick="confirm('anda yakin ingin menghapus data ini?')" class="btn btn-danger">Hapus</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
