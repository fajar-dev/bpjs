                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-beetwen">
                                <h4 class="card-title">Tambah data JKK</h4>
                            </div>  
                              ...
                              <div class="basic-form">
                                <form method="POST" action="{{ route('jkk_submit') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="date" class="form-control" name="tgl_terima_berkas"  required>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="stmb"  required>
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                      <label class="col-sm-2 col-form-label">Kekurangan Berkas</label>
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="kekurangan_berkas">
